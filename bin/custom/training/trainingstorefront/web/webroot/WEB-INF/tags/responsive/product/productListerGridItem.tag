	...
	<ycommerce:testId code="product_wholeProduct">
		...
		<div class="details">
			...
			<div class="questionCount">
                <img src="/trainingstorefront/medias/questionsIcon.png?context=bWFzdGVyfHJvb3R8MjMwNnxpbWFnZS9wbmd8YUdObUwyZ3dNQzg0T0RBeE5EZ3pNRE13TlRVNExuQnVad3xkMjc0MzM1MGI4OGQ3MDQwNjIwMGE3Mzg3ZmE2ZmMwZGRhYzAyZWIwNWNkNTAwMDMxZThjYzUwOTcyNGZmODBj" alt="icon"/>
                ${product.questionCount}
            </div>
            <div class="product_warrantyYears">
